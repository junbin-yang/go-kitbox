...
func init() {
	...
	calcMem("Zallocrout", func() {
		githubZallocrout = loadZallocrout(githubAPI)
	})
	// calcMem("Zeus", func() {
...
func BenchmarkZallocrout_GithubStatic(b *testing.B) {
	req, _ := http.NewRequest("GET", "/user/repos", nil)
	benchRequest(b, githubZallocrout, req)
}
...
func BenchmarkZallocrout_GithubParam(b *testing.B) {
	req, _ := http.NewRequest("GET", "/repos/julienschmidt/httprouter/stargazers", nil)
	benchRequest(b, githubZallocrout, req)
}
...
func BenchmarkZallocrout_GithubAll(b *testing.B) {
	benchRoutes(b, githubZallocrout, githubAPI)
}

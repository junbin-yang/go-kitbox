...
func init() {
	...
	calcMem("Zallocrout", func() {
		staticZallocrout = loadZallocrout(staticRoutes)
	})
	// calcMem("Zeus", func() {
...
func BenchmarkZallocrout_StaticAll(b *testing.B) {
	benchRoutes(b, staticZallocrout, staticRoutes)
}

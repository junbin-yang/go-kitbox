...
func init() {
	...
	calcMem("Zallocrout", func() {
		parseZallocrout = loadZallocrout(parseAPI)
	})
	// calcMem("Zeus", func() {
...
func BenchmarkZallocrout_ParseStatic(b *testing.B) {
	req, _ := http.NewRequest("GET", "/1/users", nil)
	benchRequest(b, parseZallocrout, req)
}
...
func BenchmarkZallocrout_ParseParam(b *testing.B) {
	req, _ := http.NewRequest("GET", "/1/classes/go", nil)
	benchRequest(b, parseZallocrout, req)
}
...
func BenchmarkZallocrout_Parse2Params(b *testing.B) {
	req, _ := http.NewRequest("GET", "/1/classes/go/123456789", nil)
	benchRequest(b, parseZallocrout, req)
}
...
func BenchmarkZallocrout_ParseAll(b *testing.B) {
	benchRoutes(b, parseZallocrout, parseAPI)
}

...
func init() {
	...
	calcMem("Zallocrout", func() {
		gplusZallocrout = loadZallocrout(gplusAPI)
	})
	// calcMem("Zeus", func() {
...
func BenchmarkZallocrout_GPlusStatic(b *testing.B) {
	req, _ := http.NewRequest("GET", "/people", nil)
	benchRequest(b, gplusZallocrout, req)
}
...
func BenchmarkZallocrout_GPlusParam(b *testing.B) {
	req, _ := http.NewRequest("GET", "/people/118051310819094153327", nil)
	benchRequest(b, gplusZallocrout, req)
}
...
func BenchmarkZallocrout_GPlus2Params(b *testing.B) {
	req, _ := http.NewRequest("GET", "/people/118051310819094153327/activities/123456789", nil)
	benchRequest(b, gplusZallocrout, req)
}
...
func BenchmarkZallocrout_GPlusAll(b *testing.B) {
	benchRoutes(b, gplusZallocrout, gplusAPI)
}

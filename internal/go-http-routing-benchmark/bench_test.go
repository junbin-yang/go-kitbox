...
func BenchmarkZallocrout_Param(b *testing.B) {
	router := loadZallocroutSingle("GET", "/user/:name", zallocroutHandler)
...
func BenchmarkZallocrout_Param5(b *testing.B) {
	router := loadZallocroutSingle("GET", fiveColon, zallocroutHandler)
...
func BenchmarkZallocrout_Param20(b *testing.B) {
	router := loadZallocroutSingle("GET", twentyColon, zallocroutHandler)
...
func BenchmarkZallocrout_ParamWrite(b *testing.B) {
	router := loadZallocroutSingle("GET", "/user/:name", zallocroutHandlerWrite)
